...
CTEST(read_text, test2)
{
    ...
    strcat(exp,
           "ready above ever red list though feel talk bird soon body dog ");
    strcat(exp,
    ...
    strcat(exp, "order fire south problem piece told knew pass");
...
CTEST(read_text, test3)
{
    ...
    char exp[MAX_LENGTH_OF_TEXT];
    strcpy(exp,
           "938.577 546.141 -101.857 415.925 88.079 -165.696 518.560 638.259 ");
    strcat(exp, "363.320 -818.866 427.647 -773.357 586.360 725.798 222.424 ");
    strcat(exp, "-281.021 ");
    strcat(exp, "856.052 -166.864 664.500 392.728 725.444 737.927 371.883 ");
    strcat(exp, "-494.384 ");
    strcat(exp, "238.898");
...
CTEST(read_text, test4)
{
    ...
    char exp[MAX_LENGTH_OF_TEXT];
    strcpy(exp, "1+2=3 5*6=30 6-6=0 (89*89)/89=89 log10(10)=1 x*3x+4=39/x ");
    strcat(exp, "53*4=212 ");
    strcat(exp, "y=sin(x) y=x^2-x+4 (x+2)^2=x^2+2x+4 36y+23x=31 z=3x+4y-32 ");
    strcat(exp, "1/2+1/4=0.75 2^8=256 256/128=2 39*39=1521 26x+95=0 ");
